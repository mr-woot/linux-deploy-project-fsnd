...
35.161.139.158 is my [PUBLIC\_IP] or [HOST\_IP]<br>
...
* In your terminal, type in ``ssh -i ~/.ssh/udacity_key.rsa root@35.161.139.158``
 ...
 * To login remotely into grader's account, ``ssh -i ~/.ssh/id_rsa grader@35.161.139.158`` (in my case, ``ssh -i ~/.ssh/linuxSetup grader@35.161.139.158``).
